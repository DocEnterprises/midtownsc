  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`fixed bottom-6 right-6 glass rounded-2xl shadow-xl overflow-hidden transition-all duration-300 ${
        ...
        <div className="p-4 border-b border-white/10">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                {isMinimized ? <MessageSquare className="w-4 h-4" /> : <MinusCircle className="w-4 h-4" />}
              </button>
            </div>
          </div>
        </div>
            ...
            <div className="flex-1 flex flex-col">
              {selectedChat ? (
                <>
                  ...
                  <ChatInput onSend={content => sendMessage(content, selectedChat)} />
                </>
              ) : (
